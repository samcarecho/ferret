...
VOTE_RESOURCE = endpoints.ResourceContainer(
    message_types.VoidMessage,
    userID = messages.IntegerField(1, variant=messages.Variant.INT32, required=True),
    friendID = messages.IntegerField(2, variant=messages.Variant.INT32, required=True),
